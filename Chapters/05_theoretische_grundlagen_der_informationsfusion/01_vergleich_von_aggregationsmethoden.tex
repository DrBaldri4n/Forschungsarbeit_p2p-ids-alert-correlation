\section{Vergleich von Aggregationsmethoden}
    ...
    \todohl{Rechtschreiubng}{verbessere den abschnitt auf Rechtschreibung}
    Nun da jeder Knoten automatisiert einen umfangreichen Thrat Report erstellt und eine Vielzahl von Informationen über die Bedrohungslage and seine Nachbarn weitergeben kann, stellt sich die Frage, wie diese Informationen am effektivsten zur verbesserten Erkennung von Angriffen des einzelnen Knotens genutzt werden kann.
    ...
    \begin{itemize}
        ...
        \item Die Informationen werden an die Nachbarn in einem Peer-to-Peer Netzwerk weitergegeben über die Pub/Sub Infrastruktur wie in Kapitle (Systemarchitektur und Detection Framework) \ref{chapter:systemarchitektur} beschrieben, in einem festen Intervall von 60 Sekunden.
    ...
    \todohl{klassiche problem von neuronalen netzten ist, dass sie immer einen festen Eingabe Menge benötigen, folgend wird untersucht, welche methoden es gibt um dies sicherzustellen, da die zahl er erhaltenen CTI-reports variabel ist darauf aber ein Machine Learning algorithmus trainiert werden muss}{baue den part noch in die erklärung mit ein.}
