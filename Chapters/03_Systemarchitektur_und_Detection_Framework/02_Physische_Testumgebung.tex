...
Darüber hinaus besteht eine serielle \textit{I2C}-Verbindung (\textit{Inter-Integrated Circuit}) zwischen der ChargeIQ-Wallbox und einem Einplatinencomputer in diesem Fall, der Raspberry Pi 4 B, welcher stellvertretend für die spätere Detection-Einheit auf Basis des Raspberry Pi Zero 2 W fungiert. Diese Verbindung ermöglicht die Erfassung von Echtzeitdaten des integrierten Wattmeters, welcher die Sensordaten für eine im Kapitel "Detection-Einheiten der Ladeinfrastruktur"~\ref{sec:detection_einheiten_der_ladeinfrastruktur} beschriebene Einheit bereitstellt.

Zusätzliche Sensordaten werden dem Raspberry Pi 4 B über die in der Testumgebung eingerichtete drahtlose WLAN-Verbindung übermittelt, in welche sowohl die als Detection-Einheit eingesetzte Einplatinencomputer als auch die Wallboxen eingebunden sind.
