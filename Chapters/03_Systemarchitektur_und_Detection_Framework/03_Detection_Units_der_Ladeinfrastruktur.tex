...
Im Folgenden werden die vier Hauptdetektionseinheiten der Testumgebung vorgestellt, die im Rahmen dieses Projektes implementiert wurden und für den \textit{Cyber Threat Report} sowie den \textit{Aggregierten Cyber Threat Report} von zentraler Bedeutung sind. 
    ...
    Diese Detektionseinheit arbeitet mit einer klassischen regelbasierten Logik, welche IDS-Muster zuordnet und auf Basis von Schwellenwerten für physikalische Parameter (Spannung, Leistung, Temperatur) Anomalien detektiert. Die Detektion ist in zwei Bereiche unterteilt:
