...
\label{sec:analyse_des_echo_chamber_effekts}
...
mit:
\begin{itemize}
    \item \(agg\): aggregierter Wert eines einzelnen Features im \textit{Aggregierten\_Threat\_Report}
    \item \(\text{report}_i\): Feature-Wert des \(i\)-ten Threat-Reports
    \item \(\text{weight}_i\): Gewichtung des \(i\)-ten Threat-Reports
\end{itemize}
