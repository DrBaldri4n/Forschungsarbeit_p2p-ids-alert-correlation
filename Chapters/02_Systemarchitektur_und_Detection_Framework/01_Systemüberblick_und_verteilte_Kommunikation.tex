...
Der \textit{Aggregator} innerhalb des Detection-Clients sammelt die Messdaten. Prometheus scraped alle Exporter in konfigurierbaren Intervallen. Der \textit{Reporter} liest die aggregierten Daten aus der Prometheus-Datenbank und übermittelt sie an den \texttt{ipfs-wrapper}.
...
\todohl{}{Warum genau habe ich das jz beschrieben noch ein abschließender Satz}