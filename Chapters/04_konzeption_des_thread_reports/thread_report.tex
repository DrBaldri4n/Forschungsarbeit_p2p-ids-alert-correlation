...
Die statistische Auswertung der Merkmale im Zeitverlauf umfasst folgende Kennzahlen:
    ...
    Durch diese Methodik entsteht ein umfassender Report, der nicht nur eine Momentaufnahme der Detektionseinheiten liefert, sondern auch die zeitliche Entwicklung über die letzten 60 Sekunden bzw. durch die Sliding Windows bis zu 120 Sekunden in die Vergangenheit abbildet. Diese Datenbasis dient als Input für eine spätere Aufbereitung und Training eines Machine-Learning-Modells, welcher in Kapitel~\ref{chapter:diskussion_und_forschungsluecke} (Diskussion und Forschungslücke) beschrieben sind.\\
