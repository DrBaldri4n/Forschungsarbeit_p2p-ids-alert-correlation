...
\label{sec:systemarchitektur}
	...
	\input{Chapters/02_Systemarchitektur_und_Detection_Framework/03_Datenakquiseund_Feature-Extraktion_via_Prometheus.tex}
...
\section{Aufbau und Begründung des Datensatzes}
    \subsection{Versuchsaufbau und Datensatz-Wahl}
	\subsection{Welche Angriffe wurden Gefahren und über welchen zeitraum?}

\newpage

\section{Evaluation der Aggregationsmethoden}
    \subsection{Analyse der Detection-Genauigkeit (Binary vs. Probabilistic)}
    \subsection{Vergleich der Aggregationsergebnisse Besser oder schlechter mit Agg CTI-Reports?}

\newpage

\section{Diskussion und Forschungslücke}
    \subsection{Identifikation der Forschungslücke: Optimale Gewichtungsfunktionen}
    \subsection{Potenzial für zukünftige Optimierungen im Sommer-Paper}

\newpage

\section{Ausblick: KI-gestützte Report-Generierung}
    \subsection{LLM-basierte Aufbereitung von CTI-Reports}
    \subsection{Automatisierung nach dem AGIR-Framework}
